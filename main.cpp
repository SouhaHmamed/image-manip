...
int main() {
  ...
  /* Image IM("res/euromed_image.png");
    ...
    IM.lighten(.3);
   IM.writeToFile("res/r_change.png");

    IM.saturate(.3);
    IM.writeToFile("res/s_change.png");
    IM.rotateColor(180);
     IM.writeToFile("res/trot_change.png");*/
   /* spotlight sp("res/euromed_image.png",2,2);

   sp.writeToFile("res/sp_change.png");*/

    /* Grauscale G("res/euromed_image.png");

    G.writeToFile("res/gray_change.png");*/
    /* illini I("res/euromed_image.png",11,216);

    I.writeToFile("res/ill_change.png");*/
return 0;
}
...
PROVIDED_TEST("illini") {
    ...
    illini result("res/ranbow.png",11,216);
